# 2. Write a python program to check the status code issued by server in reposnse to a client's request made to the server. Print all of the methods and attributes available to object on a succesful request
