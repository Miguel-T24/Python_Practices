# 161. Wirte a python porgram to check if a given lists increases strcitly. Moreover, if removing only ine element from the list result in a strictly increasing list, we still consider the list true.
